...
/**
 * Хук для проверки пароля и выдачи ошибок
 */
export const usePasswordValidation = () => {
  /**
   * Возвращает ключ ошибки для локализации (или null, если всё ок)
   */
  const getPasswordError = useCallback(
    (password: string, confirmPassword?: string): string | null => {
      ...
      if (!/\d/.test(password))
        return "pass_must_contain_at_least_one_number";
  ...
  /**
   * Возвращает уровень силы пароля
   */
