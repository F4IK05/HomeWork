    ...
    return (
        <>
            <div className="min-h-screen flex justify-center items-center bg-[#171719]">
                <button className="cursor-pointer absolute top-5 left-5 text-white bg-[#171719] sm:bg-[#222224] rounded-full p-3 transition-all hover:scale-[1.1] active:scale-[0.95]" onClick={() => navigate(-1)}>
                    <ChevronLeft />
                </button>
